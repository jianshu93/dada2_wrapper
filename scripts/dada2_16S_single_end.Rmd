---
title: "DADA2 analysis of 16S rRNA gene amplicon sequencing reads--single end or forward only"
author: "Jianshu Zhao"
date: "`r Sys.Date()`"
output: 
...
rd.counts <- as.data.frame(
  filterAndTrim(fnFs.noprimer, filtFs, truncLen=225,
...
#3print(paste("Error learning finishes at",Sys.time, sep = " "))
